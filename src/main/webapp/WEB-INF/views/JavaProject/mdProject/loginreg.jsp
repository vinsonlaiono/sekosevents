...
<head>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: #e3f2fd;">
			...
			<div class="container">
			<br>
				<h1 class="text-center font-weight-bold" style="padding:50px;">CUSTOMER AREA</h1>
				<br>
				<div>
					<div class="row">
						<div class="col">
							<div >
								<h4 class="text-white" style="background-color: #bbbbbb; padding:10px; ">LOGIN</h4>
									<h3 style="padding:20px;">Already a customer?</h3>
								<hr>
						...
						<div class="col">
							<div >
								<h4 class="text-white" style="background-color: #bbbbbb; padding:10px; ">NEW ACCOUNT</h4>
								<h3 style="padding:20px;">Not our registered customer yet?

?</h3>
								<hr>
								<div class=" mx-auto d-block " style="width:400px; margin-top:10px;">
